    ...
    const education = [
        {
            ...
            institute: "Sylhet Polytectnic Institute",
            year: "2020 - 2024",
        },
        {
            title: "Higher Secondary Certificate",
            institute: "UCEP Hafiz Mazumder Syltet Technical School, Sylhet",
            year: "2018 - 2020",
        },
    ];
                    ...
                    <div className="relative md:col-span-2">
                        ...
                        <div className="space-y-12">
                            ...
                            {education.map((item, index) => (
                                <div key={index} className="grid grid-cols-1 max-w-[500px] mx-auto  group">
                                    <motion.div
                            ...
                            {/* <div>
                                    ...
                                    <div  className="grid grid-cols-1 md:grid-cols-2 group mt-8 md:mt-0">
                                        <div className="hidden md:block" />
                                        <motion.div
                                        ...
                                        >
                                            <div className="bg-slate-900/80 backdrop-blur-md border border-white/10 p-6 rounded-3xl shadow-lg transition-all hover:border-blue-500/50">
                                                <h4 className="text-xl font-bold text-slate-100"></h4>
